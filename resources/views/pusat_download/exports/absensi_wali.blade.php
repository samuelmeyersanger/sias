...
<head>
    ...
    <style>
        ...
        .nama-siswa { white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    ...
    <table style="width: 100%; border-bottom: 2px solid #000; margin-bottom: 8px; padding-bottom: 4px;">
        <tr>
            ...
            <td style="width: 80%; text-align: center; vertical-align: middle;">
                <h2 style="margin: 1px 0; font-size: 14px; text-transform: uppercase;">DAFTAR HADIR BULANAN SISWA (WALI KELAS)</h2>
        ...
        <tbody>
            ...
            @forelse($anggota as $item)
                <tr>
                    ...
                    {{-- 31 Kolom Tanggal Kosong untuk Diisi Manual/Cetak --}}
                    @for($d = 1; $d <= 31; $d++)
                        <td></td>
                    @endfor

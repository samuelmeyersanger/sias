...
class SiswaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'kelurahan_desa' => 'required|numeric',
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'wali.*.provinsi'           => 'nullable|numeric',
            'wali.*.kota'               => 'nullable|numeric',
            'wali.*.kecamatan'          => 'nullable|numeric',
            'wali.*.kelurahan_desa'     => 'nullable|numeric',
            'wali.*.nomor_hp'           => 'nullable|string|max:20',
